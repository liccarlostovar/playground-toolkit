...
exports.Test = void 0;
__exportStar(require("./loremPicsum"), exports);
__exportStar(require("./utils"), exports);
console.log("Initialized the library");
const loremPicsum_1 = require("./loremPicsum");
const utils = __importStar(require("./utils"));
const Test = () => __awaiter(void 0, void 0, void 0, function* () {
    console.log("Lorem Picsum service configuration", loremPicsum_1.imagesService.config);
